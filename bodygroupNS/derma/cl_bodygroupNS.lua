...
function PANEL:Init()
    ...
    self.model.PaintOver = function(this, w, h)
        ...
        nut.util.drawText(str, w / 2, h - 16, color_white, 1, 1)
    end
    ...
    self.finish:SetFont("nutMediumFont")
...
function PANEL:OnClose()
    net.Start("nutBodygroupMenuClose")
    net.SendToServer()
end
...
vgui.Register("nutBodygroupMenu", PANEL, "DFrame")